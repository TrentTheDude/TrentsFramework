...
public class Line {
    ...
    public Line(Hologram hologram, Location location, String text){
        ...
        if (text.equalsIgnoreCase("")){
            armorStand.setCustomName(Framework.getFramework().color("&1"));
        }else{
            armorStand.setCustomName(Framework.getFramework().color(getText()));
        }
    ...
    public void rename(String text){
        setText(text);
        getArmorStand().setCustomName(Framework.getFramework().color(text));
    ...
    public void setText(String text) {
        ...
        if (text == null){
            ...
            getArmorStand().setCustomName(Framework.getFramework().color(getText()));
        }
        getArmorStand().setCustomNameVisible(true);
    }
